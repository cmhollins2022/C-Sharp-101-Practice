...
We can make a class, and it is good practice to make one file per class. *"If the code reads like a haiku, then you've done it correctly."* Utilize ```try``` and ```catch``` testing to test various scenarios and throw Exceptions.
